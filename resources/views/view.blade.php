...
<!-- Mirrored from htmlmystore.justthemevalley.com/fancy/single_product.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Dec 2017 07:55:14 GMT -->
<head>
<!-- Basic page needs -->
<meta charset="utf-8">
<!--[if IE]>
        ...
        <div class="col-main">
          <div class="product-view-area">
            ...
            <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="price-box">
                <p class="special-price"> <span class="price-label">Price</span> <span class="price"> ${{ $data->purchase_price }}</span> </p>
