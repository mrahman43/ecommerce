...
<!-- Mirrored from htmlmystore.justthemevalley.com/fancy/cat-3-col.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Dec 2017 07:55:13 GMT -->
<head>
<!-- Basic page needs -->
<meta charset="utf-8">
<!--[if IE]>
...
<!-- Favicon  -->
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('website/favicon.ico') }}">
 ...
 <div id="mobile-search">
    ...
    <li><a href="index.html" class="home1">Home</a>
      <ul>
        ...
        <li><a href="version2/index-2.html"><span>Home Version 2</span></a></li>
              ...
              <ul class="hidden-xs">
                <li class="mt-root demo_custom_link_cms">
                  ...
                  <ul class="menu-items col-md-3 col-sm-4 col-xs-12">
                    ...
                    <li class="menu-item depth-1">
                      <div class="title"> <a href="version2/index-2.html"><span>Home Version 2</span></a></div>
                    </li>
                    <li class="menu-item depth-1">
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumb has-hover-img">
                        ...
                        <figure> <a href="{{ asset('products/' . $product->id) }}"><img src="{{ asset('images/products/' . $product->image) }}" alt=""></a></figure>
                        <div class="pr-info-area animated animate2"><a href="{{ asset('products/' . $product->id) }}" class="quick-view"><i class="fa fa-search"><span>Quick view</span></i></a> <a href="wishlist.html" class="wishlist"><i class="fa fa-heart"><span>Wishlist</span></i></a> <a href="compare.html" class="compare"><i class="fa fa-exchange"><span>Compare</span></i></a> </div>
                      </div>
                      <div class="item-info">
                        <div class="info-inner">
                          ...
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price">${{ $product->purchase_price }}</span> </span> </div>
                            </div>
          ...
          <div class="block shop-by-side">
            ...
            <div class="block-content">
                ...
                <div class="layered-content">
                  <ul class="check-box-list">
                    ...
                    <li>
                      ...
                      <label for="jtv1"> <span class="button"></span> {{ $category->name }}</label>
                    </li>
                    @endforeach
                  </ul>
                </div>
              ...
              <div class="manufacturer-area">
                <h2 class="saider-bar-title">Subcategory</h2>
                <div class="saide-bar-menu">
                  <ul>
                    @foreach ($subcategories as $subcategory)
                    <li><a href="#"><i class="fa fa-angle-right"></i> {{ $subcategory->name }}</a></li>
                    @endforeach
                  </ul>
                </div>
              </div>
...
<!--jquery-slider js -->
<script type="text/javascript" src="{{ asset('website/js/slider.html') }}"></script>

<!-- megamenu js -->
<script type="text/javascript" src="{{ asset('website/js/megamenu.js') }}"></script>
