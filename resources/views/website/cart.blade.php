                ...
                <table class="table table-bordered cart_summary">
                  ...
                  <tbody>
                    @foreach ($shoppingcarts as $shoppingcart)
                      <tr>
                        <td class="cart_product"><a href="#"><img src="{{ asset('images/products/' . $shoppingcart->image) }}" alt="Product"></a></td>
                        <td class="cart_description"><p class="product-name"><a href="#"> {{ $shoppingcart->name }} </a></p>
